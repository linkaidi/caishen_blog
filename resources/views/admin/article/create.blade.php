    ...
    <div class="form-body">
        <form action="/admin/article/store" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group"> 
                ...
                <input type="text" class="form-control" id="author" name="author" value="{{ old('author') }}" placeholder="">
            </div>
            <div class="form-group"> 
            ...
            <div class="form-group"> 
                ...
                @foreach ($tags as $v)
                @if ($v->id==old('tid'))
                <input type="radio" checked class="" id="{{ $v->id }}" name="tid" value="{{ $v->id }}">
                @else
                <input type="radio" class="" id="{{ $v->id }}" name="tid" value="{{ $v->id }}">
                @endif
